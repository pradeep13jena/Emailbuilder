...
export const imagerSize = async (req, res) => {
  ...
  // Ensure that at least one of the properties (width or height) exists in the request body
  if (!width && !height) {
    return res.status(400).json({ error: 'Please provide at least one of width or height' });
  }
